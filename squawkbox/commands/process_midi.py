...
if __name__ == '__main__':
    ...
    tokenize_parser.add_argument('--max-wait-time', type=int, default=None, help='max wait time')
    ...
    batch_tokenize_parser.add_argument('--max-wait-time', type=int, default=None, help='max wait time')
